       ...
       <div id="header">
		<div id="logo">
		     ...
		     'items'=>array(
			    ...
			    $db1 = Yii::app()->db;        
                $com1 = $db1->createCommand("SELECT * 
FROM sys_pages
ORDER BY id DESC 
LIMIT 0 , 2");
                $result1 = $com1->queryAll();	
			
                  $arr[]=array('label'=>'UPDATES', 'url'=>'#', 
		     'items'=>array(
				array('label'=>$result1[0]['name'], 'url'=>array('/pages/pagemodule/id/'.$result1[0]['id'])),
				array('label'=>$result1[1]['name'], 'url'=>array('/pages/pagemodule/id/'.$result1[1]['id'])),
				
				//array('label'=>'Weekly Bulletin September 15', 'url'=>array('/pages/pagemodule/id/27')),
               ...
               $arr[]=array('label'=>'TESTIMONY', 'url'=>array('/pages/pagemodule/id/70'));
			   $arr[]=array('label'=>'TUTORIALS', 'url'=>array('/pages/pagemodule/'));
